...
("gazebo/model_states", 10, true_local_pos_cb);
    ...
    // wait for FCU connection (to be established between MAVROS and the autopilot)
    ...
    while(ros::ok()){
        ...
        switch(next_pose){
            case 0 : ROS_INFO("Switch --- Cas 0"); goal_pos = pos0; break;
            case 1 : ROS_INFO("Switch --- Cas 1"); goal_pos = pos1; break;
            case 2 : ROS_INFO("Switch --- Cas 2"); goal_pos = pos2; break;
            case 3 : ROS_INFO("Switch --- Cas 3"); goal_pos = pos3; break;
            case 4 : ROS_INFO("Switch --- Cas 4"); goal_pos = pos4; break;
            case 5 : ROS_INFO("Switch --- Cas 5"); goal_pos = pos5; break;
            case 6 : ROS_INFO("Switch --- Cas 6"); goal_pos = pos6; break;
            case 7 : ROS_INFO("Switch --- Cas 7"); goal_pos = pos7; break;
